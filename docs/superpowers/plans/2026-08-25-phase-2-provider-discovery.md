...
- The pilot limits are 40 LinkedIn listings, 25 Naukri listings, one JSearch request, and a US$0.50 maximum Apify charge. The real-data micro-run verification is limited to five listings per Apify Actor, US$0.10 per Actor when supported, and one JSearch request.
